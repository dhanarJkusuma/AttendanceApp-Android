...
import com.dhanarjkusuma.sarihusada.sarihusada.view.mypro.fragments.MyProFragmentDetail;
...
public class MyProDetailPeserta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_pro_detail_peserta);
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new MyProFragmentDetail(),"Data", bundle);
