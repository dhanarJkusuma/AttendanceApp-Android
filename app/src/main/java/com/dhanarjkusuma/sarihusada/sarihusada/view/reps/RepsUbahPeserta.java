...
public class RepsUbahPeserta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reps_ubah_peserta);
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new RepsFormUpdatePeserta(),"Update", bundle);
