...
public class SHSearchBy extends AppCompatActivity implements DoRequestInterface, View.OnClickListener {
    ...
    private FormSHSearchByPresenter presenter;
        ...
        Snackbar.make(findViewById(R.id.mainPage), "Token expired. Mohon untuk login kembali.", Snackbar.LENGTH_LONG)
                .addCallback(new BaseTransientBottomBar.BaseCallback<Snackbar>() {
                    ...
                    public void onDismissed(Snackbar transientBottomBar, int event) {
                        super.onDismissed(transientBottomBar, event);
                        session.logout();
                        Intent loginPage = new Intent(SHSearchBy.this, LoginActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.submitBtn:
                Intent readPage = new Intent(this, SHReadPeserta.class);
