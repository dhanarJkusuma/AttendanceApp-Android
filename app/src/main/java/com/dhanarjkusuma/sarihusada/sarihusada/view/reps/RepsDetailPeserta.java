...
import com.dhanarjkusuma.sarihusada.sarihusada.view.reps.fragments.RepsFragmentDetail;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class RepsDetailPeserta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reps_detail_peserta);
    ...
    private void setUpViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new RepsFragmentDetail(),"Data", bundle);
